...
<!-- Mirrored from themesdesign.in/tailwick/html-rtl/onepage-landing.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Aug 2025 14:28:51 GMT -->
<head>
                ...
                <div class="order-2 xl:col-span-5 xl:order-1">
                    <div class="relative z-10 grid grid-cols-3 gap-5 xl:grid-cols-12">
                        <div class="xl:col-span-12">
                            <img src="assets/images/widgets.jpg" alt="" class="shadow-xl rtl:mr-auto ltr:ml-auto rounded-xl">
                        </div>
                        <div class="xl:col-span-6">
                            <img src="assets/images/widgets-3.jpg" alt="" class="shadow-xl xl:mt-5 rtl:mr-auto ltr:ml-auto rounded-xl">
                        </div>
                        <div class="xl:col-span-6">
                            <img src="assets/images/widgets-2.jpg" alt="" class="shadow-xl xl:mt-5 rtl:mr-auto ltr:ml-auto rounded-xl">
                        </div>
                    </div>
                </div>
                <div class="relative z-20 order-1 xl:-mt-72 xl:col-span-7 xl:order-last">
                    <img src="assets/images/home.jpg" alt="" class="shadow-2xl rounded-xl">
                </div>
            </div>
            <div class="mt-24">
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 xl:grid-cols-12 gap-x-5">
                <div class="xl:col-span-4">
                    <div class="transition-all duration-300 ease-linear -mt-36 card hover:-translate-y-2 dark:bg-zink-600">
                        <div class="p-6">
                            <img src="assets/images/chat.jpg" alt="" class="rounded-md shadow">
                            <div class="mt-6">
                                ...
                                <a href="#!" class="text-custom-500 text-16">Read More <i data-lucide="move-right" class="inline-block align-middle size-4 ltr:ml-1 rtl:mr-1 rtl:rotate-180"></i></a>
                            </div>
                        </div>
                    </div>
                </div><!--end col-->
                <div class="xl:col-span-4">
                    <div class="transition-all duration-300 ease-linear md:-mt-36 card hover:-translate-y-2 dark:bg-zink-600">
                        <div class="p-6">
                            <img src="assets/images/email.jpg" alt="" class="rounded-md shadow">
                            <div class="mt-6">
                ...
                <div class="xl:col-span-4">
                    <div class="transition-all duration-300 ease-linear xl:-mt-36 card hover:-translate-y-2 dark:bg-zink-600">
                        <div class="p-6">
                            <img src="assets/images/order-overview.jpg" alt="" class="rounded-md shadow">
                            <div class="mt-6">
        ...
        <div class="container 2xl:max-w-[87.5rem] px-4 mx-auto">
            ...
            <div class="grid grid-cols-1 mt-16 gap-x-5 md:grid-cols-2 xl:grid-cols-4">
                <div class="!shadow-lg text-15 card">
                    <div class="card-body">
                        <h5 class="mb-2"><i data-lucide="goal" class="inline-block text-green-500 size-5 ltr:mr-1 rtl:ml-1"></i> <span class="align-middle">Lite</span></h5>
                ...
                <div class="!shadow-lg text-15 card">
                    <div class="card-body">
                        <h5 class="mb-2"><i data-lucide="graduation-cap" class="text-purple-500 inlinesize ltr:mr-1 rtl:ml-1"></i> <span class="align-middle">Professional</span></h5>
                ...
                <div class="relative overflow-hidden card !shadow-lg text-15">
                    <div class="card-body">
                        ...
                        <h5 class="mb-2"><i data-lucide="crown" class="inlinesize ltr:mr-1 rtl:ml-1 text-sky-500"></i> <span class="align-middle">Enterprise</span></h5>
                ...
                <div class="!shadow-lg text-15 card">
                    <div class="card-body">
                        <h5 class="mb-2"><i data-lucide="luggage" class="text-orange-500 inlinesize ltr:mr-1 rtl:ml-1"></i> <span class="align-middle">Unlimited</span></h5>
                ...
                <div class="relative z-10 grid grid-cols-1 gap-5 md:grid-cols-12">
                    ...
                    <div class="md:col-span-3 md:col-start-10">
                        <ul class="flex items-center gap-3 md:justify-end">
                            <li>
                                <a href="#!" class="flex items-center justify-center w-10 h-10 transition-all duration-200 ease-linear border rounded-full text-slate-400 border-slate-700 hover:text-custom-500"><i data-lucide="facebook" class="size-4"></i></a>
                            </li>
                            <li>
                                <a href="#!" class="flex items-center justify-center w-10 h-10 transition-all duration-200 ease-linear border rounded-full text-slate-400 border-slate-700 hover:text-custom-500"><i data-lucide="linkedin" class="size-4"></i></a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="#!" class="flex items-center justify-center w-10 h-10 transition-all duration-200 ease-linear border rounded-full text-slate-400 border-slate-700 hover:text-custom-500"><i data-lucide="twitter" class="size-4"></i></a>
                            </li>
                            <li>
...
<!-- Mirrored from themesdesign.in/tailwick/html-rtl/onepage-landing.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Aug 2025 14:29:55 GMT -->
</html>